...
$$r = \frac{2{,}440}{40} = 61 \text{ units/hour} \approx 60 \text{ units/hour}$$
...
$$c = \frac{3{,}600 \text{ sec/hr}}{60 \text{ units/hr}} = 60 \text{ seconds per unit}$$
...
$$TM = \frac{\text{Total task time}}{\text{Cycle time}}$$

**Example:** Total task time = 244 seconds, cycle time = 60 seconds:

$$TM = \frac{244}{60} = 4.07 \rightarrow \text{round up to } 5 \text{ stations}$$
...
$$\text{Efficiency} = \frac{\text{Total task time}}{\text{Number of stations} \times \text{Cycle time}} \times 100\%$$
...
![[Pasted image 20260318121737.png]]
...
Apply rule: **B (30 sec)** is longest.
...
Apply rule: **F (25 sec)** is longest.
...
|S5|E, H, I|6 + 20 + 18|44 sec|16 sec|
...
$$\text{Efficiency} = \frac{\text{Total task time}}{\text{Number of stations} \times \text{Cycle time}} = \frac{244}{5 \times 60} = \frac{244}{300} = 81.3\%$$

$$\text{Balance Delay} = 1 - 0.813 = 18.7\%$$

**Interpretation:** 81.3\% of the available line capacity is being used for actual work. The remaining 18.7% is idle time spread across the five stations. The heaviest idle time is at S5 (16 sec) and S1 (20 sec).
